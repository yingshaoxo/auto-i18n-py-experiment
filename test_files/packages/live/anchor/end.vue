  ...
  <view class="pages">
    ...
    <view class="warp">
      ...
      <view class="statistic-card card-group-box">
        <view class="item">
          <view class="text">{{ info.point_total_num }}</view>
          <view class="title">收穫積分</view>
        </view>
        <view class="item">
          <view class="text">{{ info.watch_member_num }}</view>
          <view class="title">觀看人數</view>
        </view>
        <view class="item">
        ...
        <view class="item">
          <view class="text">{{ info.fans_num }}</view>
          <view class="title">新增粉絲</view>
        </view>
        <view class="item">
          <view class="text">{{ info.gift_member_num }}</view>
          <view class="title">打賞人數</view>
        </view>
        <view class="item">
          <view class="text">{{ info.comment_member_num }}</view>
          <view class="title">評論人數</view>
        </view>
        <view class="item">
